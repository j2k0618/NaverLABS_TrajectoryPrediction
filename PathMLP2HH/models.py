...
from PathMLP2HH.model_utils import *
...
class CAM(SimpleEncoderDecoder):
    ...
    def encoder(self, past_agents_traj, past_agents_traj_len, future_agent_masks, num_past_agents):
        ...
        agent_lstm_encodings = self.agent_encoder(past_agents_traj, past_agents_traj_len.cpu()).squeeze(0) # [B X H]
