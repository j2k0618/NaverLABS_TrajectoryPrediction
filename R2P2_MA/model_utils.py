...
class Bilinear_Interpolation(nn.Module):
    ...
    def forward(self, episode_idx, positions, grid_map, padding_val=0.0):
        ...
        positions_map = (positions + 32)/64.0 * 64.0 + 1.0
        ...
        floor_positions_map = torch.clamp(floor_positions_map, 0, 65)
        ceil_positions_map = torch.clamp(ceil_positions_map, 0, 65)
